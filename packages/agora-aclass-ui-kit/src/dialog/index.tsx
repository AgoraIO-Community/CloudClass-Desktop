    ...
    >
      ...
      >
        ...
        <DialogButtons classes={{root: classes.dialogButtonGroup}}>
          {props.confirmText ? <AButton color="primary" onClick={onConfirm} text={props.confirmText}></AButton> : null}
          {props.cancelText ? <AButton color="secondary" onClick={onCancel} text={props.cancelText}></AButton> : null}
        </DialogButtons>
      </MDialogContent>
    </MDialog>
  )
...
export const ADialog = (props: DialogProps) => (
  <CustomizeTheme>
    <Dialog {...props} />
  </CustomizeTheme>
)
...
export const APromptDialog = (props: PromptDialogProps) => (
  <CustomizeTheme>
    <PromptDialog {...props} />
  </CustomizeTheme>
)