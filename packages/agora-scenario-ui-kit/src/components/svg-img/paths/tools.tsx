...
export const path = (props: PathOptions) =>
    <g fill="none">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M9 6V7H5C4.44772 7 4 7.44772 4 8V10H20V8C20 7.44772 19.5523 7 19 7H15V6C15 5.44772 14.5523 5 14 5H10C9.44772 5 9 5.44772 9 6ZM14 6H10V7H14V6Z" fill={props.iconPrimary} fill-opacity="0.7" />
    </g>
