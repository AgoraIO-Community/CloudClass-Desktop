export const en = {
  ...
  breakout_room: {
    ...
    confirm_invite_teacher_title: 'Ask for help',
    confirm_invite_teacher_content: '{reason2} in Room {reason1} asked for help',
    confirm_invite_teacher_btn_ok: 'Join',
    confirm_invite_teacher_btn_cancel: 'Later',
    confirm_invite_student_title: 'Join Breakout Room',
    confirm_invite_student_content: 'Teacher invites you to join {reason}?',
    confirm_invite_student_btn_ok: 'Join',
    confirm_invite_student_btn_cancel: 'Later',
    confirm_ask_for_help_busy_content:
    ...
    confirm_ask_for_help_content: 'You can invite the host to this Breakout Room for assistance.',
    confirm_ask_for_help_btn_ok: 'Invite',
