export const en = {
  ...
  'roster': {
    ...
    'close_student_co_video': "You've stepped down and you can't interact for the time being.",
    'open_student_co_video': "You have been invited by {{teacher}} to the stage, please actively interact.",
    'board_state': 'Board',
    'camera_state': 'Camera',
