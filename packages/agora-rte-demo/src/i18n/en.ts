...
const en = {
  "aclass": {
    ...
    'sure_open_share_screen': 'Are you sure open Screen Share',
    'confirm_open': 'sure',
  ...
  'placeholder': {
    'teacher_noEnter': 'Waiting for teacher enter the classroom...',
    'student_noEnter': 'Waiting for students enter the classroom...',
    'teacher_Left': 'The teacher have left the classroom',
    'student_Left': 'The student have left the classroom',
    'closedCamera': 'Closed Camera',
  ...
  'whiteboard': {
    ...
    'downloading2': 'Downloading material, please wait...',
    'loading': 'Loading...',
