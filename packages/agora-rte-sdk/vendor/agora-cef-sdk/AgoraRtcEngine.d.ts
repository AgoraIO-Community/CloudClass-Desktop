...
export declare namespace AgoraRtcEngine {
   ...
   *   - -5(`ERR_REFUSED`)
   */
  function joinChannelWithUserAccount(
    token: string,
    channelId: string,
    userAccount: string,
  ): number;
   ...
   * - < 0: Failure.
   */
  function enableAudioVolumeIndication(
    interval: number,
    smooth: number,
    report_vad: boolean,
  ): number;
   ...
   * - < 0: Failure.
   */
  function setHighQualityAudioParameters(
    fullband: boolean,
    stereo: boolean,
    fullBitrate: boolean,
  ): number;
   ...
   * - < 0: Failure.
   */
  function setLocalVoiceEqualization(
   ...
   * @param param2
   */
  function setAudioEffectParameters(
   ...
   * - < 0: Failure.
   */
  function setRecordingAudioFrameParameters(
    sampleRate: number,
    channel: number,
   ...
   * - < 0: Failure.
   */
  function setPlaybackAudioFrameParameters(
    sampleRate: number,
    channel: number,
    mode: RAW_AUDIO_FRAME_OP_MODE_TYPE,
    samplesPerCall: number,
   ...
   * @param restriction
   */
  function setAudioSessionOperationRestriction(
   ...
   * @param captureParams
   */
  function startScreenCaptureByDisplayId(
    displayId: number,
   ...
   * @param captureParams
   */
  function startScreenCaptureByScreenRect(
   ...
   * @param captureParams
   */
  function startScreenCaptureByWindowId(
    windowId: number,
    regionRect: Rectangle,
    captureParams: ScreenCaptureParameters,
  ): number;
   ...
   * with us.
   */
  function sendCustomReportMessage(
    id: string,
    category: string,
    event: string,
    label: string,
