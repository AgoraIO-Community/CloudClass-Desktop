...
export class EduClassroomDataController {
  ...
  addStreams(
    ...
    const streams = rawStreams.filter((it: EduStreamData) =>
      cachedUserIds.includes(it.stream.userInfo.userUuid),
    );
    EduLogger.info(
  ...
  setRoomBatchProperties(
    ...
    const mergeRoomProperties = (properties: any, changedProperties: any) => {
      ...
      console.log(
        '#### roomProperties setWith.forEach, setRoomBatchProperties',
      );
