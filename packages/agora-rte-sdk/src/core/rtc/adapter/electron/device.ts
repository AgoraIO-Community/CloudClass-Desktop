...
export class RtcVideoDeviceManagerElectron extends RtcVideoDeviceManagerBase {
  ...
  constructor(private readonly adapter: RtcAdapterElectron) {
    super();
...
export class RtcAudioDeviceManagerElectron extends RtcAudioDeviceManagerBase {
