...
// 拉取消息展示位置
export const historyCurrentHeight = (data) => {
    return { type: 'HISTORY_CURRENT_HEIGHT', data }
}

export const isHistoryCurrentLoc = (data) => {
    return { type: 'IS_HISTORY_CURRENT_LOC', data }
}
