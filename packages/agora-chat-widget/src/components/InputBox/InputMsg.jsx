        ...
        <div className="fcr-hx-chat-icon">
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            {configUIVisible.screenshotIcon && isElectron && (
              <Popover content={<ScreenshotMenu couterRef={couterRef} />} className="fcr-hx-emoji-modal">
            ...
            {configUIVisible.showQuestionBox && (
              <>
                ...
                <div className="fcr-hx-chat-question-container" onClick={toggleQuestionState}>
                  <Icon
