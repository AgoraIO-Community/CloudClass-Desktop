...
export const ToastContainer = observer(() => {
  ...
  const toastMap = {
    ...
    'toast.revoke_board_success': (props: any) =>
      toast('toast.revoke_board_success', props),
    ...
    'toast.teacher_accept_whiteboard': () =>
      toast('toast.teacher_accept_whiteboard'),
    'toast.teacher_cancel_whiteboard': () =>
      toast('toast.teacher_cancel_whiteboard'),
    ...
    'toast.setting_start_failed': (props: any) =>
      toast('toast.setting_start_failed'),
    'toast.the_course_ends_successfully': (props: any) =>
      toast('toast.the_course_ends_successfully'),
    'toast.setting_ended_failed': (props: any) =>
      toast('toast.setting_ended_failed'),
    'toast.start_recording_failed': (props: any) =>
      toast('toast.start_recording_failed', props),
    'toast.failed_to_end_recording': (props: any) =>
      toast('toast.failed_to_end_recording'),
    'error.class_end': (props: any) => toast('error.class_end', props),
    'error.room_is_full': (props: any) => toast('error.room_is_full', props),
    'error.apply_co_video_limit': (props: any) =>
      toast('error.apply_co_video_limit', props),
    'error.send_co_video_limit': (props: any) =>
      toast('error.send_co_video_limit', props),
    'error.cannot_join': (props: any) => toast('error.cannot_join', props),
    'error.unknown': (props: any) => toast('error.unknown', props),
    'pretest.camera_move_out': (props: any) =>
      toast('pretest.camera_move_out', props, 'error'),
    'pretest.mic_move_out': (props: any) =>
      toast('pretest.mic_move_out', props, 'error'),
    ...
    'private_media_chat.chat_ended': (props: any) =>
      toast('private_media_chat.chat_ended', props),
    ...
    'co_video.remote_close_camera': (props: any) =>
      toast('co_video.remote_close_camera', props),
    'co_video.remote_open_camera': (props: any) =>
      toast('co_video.remote_open_camera', props),
    'co_video.remote_open_microphone': (props: any) =>
      toast('co_video.remote_open_microphone', props),
    'co_video.remote_grant_board': (props: any) =>
      toast('co_video.remote_grant_board', props),
    'co_video.remote_close_microphone': (props: any) =>
      toast('co_video.remote_close_microphone', props),
    'co_video.remote_revoke_board': (props: any) =>
      toast('co_video.remote_revoke_board', props),
    ...
    'co_video.hands_up_requsted': (props: any) =>
      toast('co_video.hands_up_requsted', props),
    'co_video.hands_up_cancelled': (props: any) =>
      toast('co_video.hands_up_cancelled', props),
    'roster.close_student_co_video': (props: any) =>
      toast('roster.close_student_co_video', props),
    'roster.open_student_co_video': (props: any) =>
      toast('roster.open_student_co_video', props),
    'toast.add_screen_share': (props: any) =>
      toast('toast.add_screen_share', props),
    'toast.remove_screen_share': (props: any) =>
      toast('toast.remove_screen_share', props),
    'toast.mute_chat': (props: any) => toast('toast.mute_chat', props),
    'toast.unmute_chat': (props: any) => toast('toast.unmute_chat', props),
    'toast.remote_mute_chat': (props: any) =>
      toast('toast.remote_mute_chat', props),
    'toast.remote_unmute_chat': (props: any) =>
      toast('toast.remote_unmute_chat', props),
  };
  ...
  useEffect(() => {
    toastEventObserver.subscribe((evt: any) => {
      ...
      if (toastOperation) {
        if (
          evt.eventName === 'pretest.detect_new_device_in_room' &&
          !roomRef.current
        ) {
          return;
        }
