...
export abstract class RoomChatUIKitStore implements ChatUIKitModule {

  private attributes: RoomChatModel

  constructor(payload: RoomChatModel = defaultModel) {
    this.attributes = payload
    // makeObservable(this.attributes)
  }

  updateAttributes(payload: RoomChatModel = defaultModel) {
    this.attributes = payload
  }
