...
export const TeacherStream = observer(() => {
  ...
  return (
    <React.Fragment>
      ...
      {!teacherCameraStream && <StreamPlaceholder className='fcr-stream-player-container' role={EduRoleTypeEnum.teacher} style={style} />}
    </React.Fragment>

  );
});

export const StudentStream = observer(() => {
  const { streamUIStore } = useStore() as Edu1v1ClassUIStore;
  ...
  return (
    <React.Fragment>
      ...
      {!studentCameraStream && <StreamPlaceholder className='fcr-stream-player-container' role={EduRoleTypeEnum.student} style={style} />}
    </React.Fragment>
  );
});