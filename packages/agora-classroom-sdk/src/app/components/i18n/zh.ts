export default {
  ...
  fcr_create_tips_number_of_participants: '请输入人数上限',
  fcr_create_tips_number_of_participants_invalid: '请输入数字',
  ...
  fcr_create_label_camera: '摄像头',
  fcr_create_label_microphone: '麦克风',
  fcr_create_label_chat: '聊天',
  fcr_create_label_person_count_limitation: '人数限制',
  ...
  fcr_h5create_label_study_room: '自习室',
