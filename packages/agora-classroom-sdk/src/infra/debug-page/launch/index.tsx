  ...
  const mountLaunch = useCallback(async (dom: any) => {
    if (dom) {
      ...
      roomRef.current = await AgoraEduSDK.launch(dom, {
        ...
        recordUrl: REACT_APP_APAAS_BUILD_DATE ? `https://webdemo.agora.io/flexible-classroom/${REACT_APP_APAAS_BUILD_DATE}/record_page` : `https://webdemo.agora.io/flexible-classroom/record_page`,
