...
const zhCN: any = {
  ...
  toast: {
    warning_sensitive_words:
      '请注意：您的对话内容包含敏感词（例如：联系方式或金钱），这可能违反培训协议和阿卡索的其他相关规定。',
  ...
  middle_room: {
    ...
    groupText:
      '分组使用说明：选择每组人数上限进行分组。例如：教室内共5名学生，选择每组上限2人则分成3组（2 2 1），选择每组上限4人则分成两组（4 1），选择每组上限6人则分成1组（5）。',
  },
