...
def doPublish(buildVariables) {
    ...
    def archiveInfos = [
        [
          "type": "ARTIFACTORY",
          "archivePattern": "*.zip",
          "serverPath": "ClassroomSDK/${shortVersion}/${buildVariables.buildDate}/${env.platform}",
...
pipelineLoad(this, "ClassroomSDK", "build", "mac", "edu_mac")