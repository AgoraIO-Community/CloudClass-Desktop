import { useStore, useVocationalH5UIStores } from '@classroom/infra/hooks/ui-store';
import { EduVocationalH5UIStore } from '@classroom/infra/stores/vocational-h5';
...
import { useInvitedModal } from '@classroom/infra/capabilities/containers/hand-up/invite-confirm';
