...
export const StreamContext = createContext<ReturnType<typeof convertStreamUIStatus> | null>(
  null,
);
...
export const StreamToolContext = createContext<ReturnType<typeof streamTool> | null>(
  null,
);
