export const MicrophoneIndicator = ({
  ...
  return (
    <div className="fcr-microphone">
      <svg viewBox="0 0 48 48" fill={iconPrimary} width={size} height={size}>
        <defs>
          <linearGradient x1="0%" x2="0%" y1="0%" y2="100%" id="gradient">
            <stop stopColor={iconPrimary} offset="0%"></stop>
            <stop stopColor={iconPrimary} offset={`${100 - voicePercent}%`}></stop>
