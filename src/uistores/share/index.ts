import { AgoraEduSDK, WindowID } from '@classroom/index';
import { getEduErrorMessage } from '@classroom/utils/error';
import { sendToMainProcess } from '@classroom/utils/ipc';
import { ChannelType } from '@classroom/utils/ipc-channels';
