...
export const path = (props: PathOptions) =>
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M12.5 14.5C14.16 14.5 15.5 13.16 15.5 11.5V5.5C15.5 3.84 14.16 2.5 12.5 2.5C10.84 2.5 9.5 3.84 9.5 5.5V11.5C9.5 13.16 10.84 14.5 12.5 14.5Z" fill="#FEFEFE" />
