...
export const podiumColumn: Column = {
  ...
  render: (profile: Profile, hovered) => {
    ...
    const iconType =
      isActive || hovered
        ? { icon: SvgIconEnum.ON_PODIUM, color: InteractionStateColors.allow }
...
export const grantBoardColumn: Column = {
  ...
  render: (profile: Profile, hovered) => {
    ...
    iconType.color =
      isActive || hovered ? InteractionStateColors.allow : InteractionStateColors.half;
  ...
  render: (profile: Profile, hovered) => {
    return (
      <Icon
        type={
          hovered
            ? { icon: SvgIconEnum.REWARD, color: InteractionStateColors.allow }
  ...
  render: (profile: Profile, hovered) => {
    return (
      <Icon
        type={
          hovered
            ? { icon: SvgIconEnum.KICK_OUT, color: InteractionStateColors.allow }
            : { icon: SvgIconEnum.KICK_OUT, color: InteractionStateColors.half }
        }
      />
    );
  },
